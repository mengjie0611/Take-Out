<template>
   <section class="msite">
    <!--首页头部-->
    <Header :title="$store.state.address.name ||'定位中。。。' ">
    ...
    <div class="msite_shop_list">
      ...
      <div class="shop_container">
        <ul class="shop_list" v-if="$store.state.shops.length>0">
          <li class="shop_li border-1px" v-for="shop in $store.state.shops" :key="shop.id" @click="$router.push('/shop')">
            <a>
              <div class="shop_left">
